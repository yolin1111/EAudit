...
{
    [Table("AuditLineViews")]
    public partial class AuditLineView
    {
        [Key]
        ...
        [InverseProperty(nameof(AuditHeaderView.AuditLineViews))]
        public virtual AuditHeaderView HeaderView { get; set; }
    }
}